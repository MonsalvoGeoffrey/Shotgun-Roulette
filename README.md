Simulating the rules of the horror game [Buckshot Roulette](https://mikeklubnika.itch.io/buckshot-roulette) and run simulation with various strategies to check their win rate against each other strategies.
